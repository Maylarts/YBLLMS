  ...
  <body>
    ...
    <section class="ftco-section ftco-pricing">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Service Name</th> <th>Service Options</th> <th>Cost</th> </tr> </thead> <tbody>
<?php
...
?>
             ...
             <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['ServiceName'];?></td> <td> <?php  echo $row['ServiceOptions'];?></td> <td><?php     echo $row['Cost'];?></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
			</div>
		</section>
